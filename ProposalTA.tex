...
\begin{center}
    ...
    {\Large\bfseries  Pengujian Kapabilitas Deteksi \textit{Anti Spyware Mode Stealth} dalam Pengumpulan Data Intelijen Siber}\\
     \vspace{4cm}
    ...
    {\large Oleh}\\[0.3cm]
    \textbf{
    {\large Audra Zelvania Putri Harjanto}\\
    {\large 18222106}
    }\\
