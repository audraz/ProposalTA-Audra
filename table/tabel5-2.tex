...
\begin{tabular}{|p{3.2cm}|p{8cm}|p{3cm}|}
\hline
\textbf{Langkah} & \textbf{Penjelasan} & \textbf{Tools} \\ \hline
...
\textit{Modul} formatting JSON \\ \hline
...
\end{tabular}
\caption{Rencana Implementasi Modul \textit{Exfiltration}}
\label{tbl:rencana-exfiltration}
\end{table}