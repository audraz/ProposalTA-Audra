...
\begin{tabular}{|p{1.5cm}|p{3.3cm}|p{4cm}|p{4cm}|}
\hline
\textbf{ID} & \textbf{Solusi} & \textbf{Kelebihan} & \textbf{Kekurangan} \\ \hline
...
Kegiatan yang terlalu mencurigakan masih bisa memicu alarm meskipun menggunakan \textit{LOLBins}. \\ \hline
...
Memperlambat proses eksfiltrasi sehingga total waktu pengiriman data menjadi jauh lebih lama. \\ \hline
...
Berisiko menghasilkan trafik/anomali mencurigakan jika obfuscation terlalu berat. \\ \hline
...
Menambah \textit{overhead} dan berpotensi menghapus data yang masih diperlukan jika tidak diatur dengan tepat. \\ \hline
...
Lebih kompleks untuk diimplementasikan. \\ \hline
