...
\item   Mengevaluasi kinerja perangkat \textit{anti-spyware} dalam mendeteksi aktivitas \textit{data crawling} dan eksfiltrasi yang dilakukan oleh \textit{spyware} mode \textit{stealth}.
\end{enumerate}
